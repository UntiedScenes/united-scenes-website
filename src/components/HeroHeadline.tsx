...
export default function HeroHeadline() {
  ...
  return (
    <div className="space-y-2">
      <div
        ref={staticRef}
        className="reveal heading-1 light mx-auto italic opacity-0"
      >
      ...
      <div
        ref={switchRef}
        className="reveal heading-1 light mx-auto grid h-[1.15em] grid-cols-1 grid-rows-1 overflow-hidden opacity-0"
